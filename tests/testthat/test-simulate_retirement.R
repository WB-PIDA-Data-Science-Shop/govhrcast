...
create_integration_test_data <- function() {
  contract_dt <- data.table(
    ...
    contract_type = c("perm", "perm", "perm", "perm", "perm"),
...
test_that("simulate_retirement works with age_only eligibility", {
  ...
  expect_equal(result$contract_dt[contract_id == "C001"]$contract_type, "pensioner")
  expect_equal(result$contract_dt[contract_id == "C002"]$contract_type, "pensioner")
...
test_that("simulate_retirement handles retiree with multiple contracts", {
  ...
  expect_equal(result$contract_dt[contract_id == "C004"]$contract_type, "pensioner")
  expect_equal(result$contract_dt[contract_id == "C003"]$contract_type, "pensioner")
})
