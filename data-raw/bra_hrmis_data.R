...
tenure_dt <- compute_tenure_panel(contract_dt = bra_hrmis_contract,
                                  ref_date_col = "ref_date",
                                  contract_type_col = "contract_type",
                                  group_cols = "contract_id") 

tenure_dt <- tenure_dt[, c("personnel_id", "contract_id", "ref_date", "tenure_years")]

setnames(tenure_dt, "tenure_years", "contract_tenure")

### merge into the contract_dt
bra_hrmis_contract <- bra_hrmis_contract[tenure_dt, on = c("personnel_id", "contract_id", "ref_date")]


### compute personnel tenure
tenure_dt <- compute_tenure_panel(contract_dt = bra_hrmis_contract,
                                  ref_date_col = "ref_date",
                                  contract_type_col = "contract_type")

tenure_dt <- tenure_dt[, c("personnel_id", "ref_date", "tenure_years")]

setnames(tenure_dt, "tenure_years", "personnel_tenure")


bra_hrmis_personnel <- bra_hrmis_personnel[tenure_dt, on = c("personnel_id", "ref_date")]
